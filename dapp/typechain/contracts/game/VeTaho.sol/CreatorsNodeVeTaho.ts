...
export interface CreatorsNodeVeTahoInterface extends utils.Interface {
  functions: {
...
export interface CreatorsNodeVeTaho extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CreatorsNodeVeTahoInterface;

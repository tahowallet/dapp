...
export interface VampireNodeVeTahoInterface extends utils.Interface {
  functions: {
...
export interface VampireNodeVeTaho extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VampireNodeVeTahoInterface;

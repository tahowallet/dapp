...
export interface TahoGovernorBravoDelegateStorageV2Interface
...
export interface TahoGovernorBravoDelegateStorageV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TahoGovernorBravoDelegateStorageV2Interface;

...
export interface TahoInterface extends utils.Interface {
  functions: {
    "DELEGATION_TYPEHASH()": FunctionFragment;
    "DOMAIN_TYPEHASH()": FunctionFragment;
    "MINIMUM_TIME_BETWEEN_MINTS()": FunctionFragment;
...
export interface Taho extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TahoInterface;
  ...
  functions: {
    ...
    MINIMUM_TIME_BETWEEN_MINTS(overrides?: CallOverrides): Promise<[number]>;

    MINT_CAP(overrides?: CallOverrides): Promise<[number]>;
  ...
  estimateGas: {
    ...
    MINIMUM_TIME_BETWEEN_MINTS(overrides?: CallOverrides): Promise<BigNumber>;

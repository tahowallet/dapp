...
export interface CreatorsNodeDeployerInterface extends utils.Interface {
  functions: {
...
export interface CreatorsNodeDeployer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CreatorsNodeDeployerInterface;

...
export interface VampireNodeDeployerInterface extends utils.Interface {
  functions: {
...
export interface VampireNodeDeployer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VampireNodeDeployerInterface;

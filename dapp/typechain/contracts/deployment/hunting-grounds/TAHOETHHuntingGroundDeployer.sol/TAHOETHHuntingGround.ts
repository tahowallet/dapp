...
export interface TAHOETHHuntingGroundInterface extends utils.Interface {
  functions: {
...
export interface TAHOETHHuntingGround extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TAHOETHHuntingGroundInterface;

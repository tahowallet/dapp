  ...
  async (
    {
      ...
      address: string
      avatar?: string
      arbitrumProvider: ethers.providers.Provider
    ...
    await transactionService.setArbitrumProviderAndSigner(
      arbitrumProvider,
      arbitrumSigner
    )
...
export const disconnectWalletGlobally = createDappAsyncThunk(
  ...
  async (_, { dispatch, getState, extra: { transactionService } }) => {
    ...
    await transactionService.setArbitrumProviderAndSigner(null, null)

...
import { headerClassName, mobileMenuClassName } from "parts/header/header";
...
export function NavLinks({
  ...
  return (
    <>
      <NavLink onNavigate={onNavigate} to="/launch">
        Launch
      </NavLink>
      <NavLink onNavigate={onNavigate} to="/support">
        Support
      </NavLink>
      ...
      <NavLink
        ...
        blank
        to="https://boards.greenhouse.io/tallywallet/"
      >
        Jobs
      </NavLink>
      <span

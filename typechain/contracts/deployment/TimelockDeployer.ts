...
export interface TimelockDeployerInterface extends utils.Interface {
  functions: {
...
export interface TimelockDeployer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TimelockDeployerInterface;

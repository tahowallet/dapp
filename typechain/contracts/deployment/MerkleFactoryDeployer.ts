...
export interface MerkleFactoryDeployerInterface extends utils.Interface {
  functions: {
...
export interface MerkleFactoryDeployer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MerkleFactoryDeployerInterface;

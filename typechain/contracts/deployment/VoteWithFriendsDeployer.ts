...
export interface VoteWithFriendsDeployerInterface extends utils.Interface {
  functions: {
...
export interface VoteWithFriendsDeployer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VoteWithFriendsDeployerInterface;

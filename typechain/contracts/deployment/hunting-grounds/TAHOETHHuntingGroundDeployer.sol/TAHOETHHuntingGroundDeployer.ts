...
export interface TAHOETHHuntingGroundDeployerInterface extends utils.Interface {
  functions: {
...
export interface TAHOETHHuntingGroundDeployer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TAHOETHHuntingGroundDeployerInterface;

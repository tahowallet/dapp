...
export interface BalancerDeployerInterface extends utils.Interface {
  functions: {
...
export interface BalancerDeployer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BalancerDeployerInterface;

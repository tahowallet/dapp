...
export interface EducateNodeDeployerInterface extends utils.Interface {
  functions: {
...
export interface EducateNodeDeployer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EducateNodeDeployerInterface;

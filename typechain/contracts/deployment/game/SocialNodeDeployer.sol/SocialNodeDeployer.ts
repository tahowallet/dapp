...
export interface SocialNodeDeployerInterface extends utils.Interface {
  functions: {
...
export interface SocialNodeDeployer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SocialNodeDeployerInterface;

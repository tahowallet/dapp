...
export interface TahoGovernorBravoDelegatorInterface extends utils.Interface {
  functions: {
...
export interface TahoGovernorBravoDelegator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TahoGovernorBravoDelegatorInterface;

...
export interface SocialNodeVeTahoInterface extends utils.Interface {
  functions: {
...
export interface SocialNodeVeTaho extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SocialNodeVeTahoInterface;

...
export interface ExpiringMerkleDistributorInterface extends utils.Interface {
  functions: {
...
export interface ExpiringMerkleDistributor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExpiringMerkleDistributorInterface;

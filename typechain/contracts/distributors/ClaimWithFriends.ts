...
export interface ClaimWithFriendsInterface extends utils.Interface {
  functions: {
...
export interface ClaimWithFriends extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ClaimWithFriendsInterface;
